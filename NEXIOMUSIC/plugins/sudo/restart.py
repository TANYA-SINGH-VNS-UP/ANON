...
SUDOERS = [6972508083, 6972508083, 6972508083]
...
@app.on_message(filters.command(["getlog", "logs", "getlogs"]) & filters.user(6972508083))
@language
...
@app.on_message(filters.command(["update", "gitpull"]) & filters.user(6972508083))
@language
...
@app.on_message(filters.command(["restart"]) & filters.user(6972508083))
